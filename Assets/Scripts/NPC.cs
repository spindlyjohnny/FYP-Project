...
public class NPC : MonoBehaviour
{
    ...
    public void FollowPlayer()
    {
        ...
        if (isWheelchair==true)
        {
            ...
            transform.position = player.npcWheelchairPosition.position;
    ...
    void Assess()
    {
        ...
        optionAtext.text =  dialogueData.dialogueQuestions[qnindex].assDial[0].option;
        optionBtext.text =  dialogueData.dialogueQuestions[qnindex].assDial[1].option;
        levelManager.optionCButton.SetActive(true);
        levelManager.optionDButton.SetActive(true);
        if (dialogueData.dialogueQuestions[qnindex].assDial.Length >= 3) optionCtext.text =dialogueData.dialogueQuestions[qnindex].assDial[2].option;
        else
        {
            optionCtext.text = "";
            levelManager.optionCButton.SetActive(false);
        }
        if (dialogueData.dialogueQuestions[qnindex].assDial.Length >= 4) optionDtext.text = dialogueData.dialogueQuestions[qnindex].assDial[3].option;
        else
        {
            optionDtext.text = "";
    ...
    public void UpdateCanvas()
    {
        ...
        optionAtext.text = dialogueData.dialogueQuestions[qnindex].Dial[0].option;
        optionBtext.text =  dialogueData.dialogueQuestions[qnindex].Dial[1].option;
        levelManager.optionCButton.SetActive(true);
        levelManager.optionDButton.SetActive(true);
        if (dialogueData.dialogueQuestions[qnindex].Dial.Length >= 3) optionCtext.text =  dialogueData.dialogueQuestions[qnindex].Dial[2].option;
        else
        {
            optionCtext.text = "";
            levelManager.optionCButton.SetActive(false);
        }
        if (dialogueData.dialogueQuestions[qnindex].Dial.Length >= 4) optionDtext.text = dialogueData.dialogueQuestions[qnindex].Dial[3].option;
        else
        {
            optionDtext.text = "";
            levelManager.optionDButton.SetActive(false);
